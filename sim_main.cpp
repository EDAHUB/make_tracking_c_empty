...
int main(int argc, char** argv, char** env) {
	...
	my_counter ++;
        ...
        top->in_small = my_counter;

	top->top->sub->out_small =  my_rand()<<8 | my_counter;
	...
	// ==================================
	printf ("[Collect sub data] clk =%d, reset=%d, in_small=%x, out_small=%x\n",
			top->top->sub->clk, top->top->sub->reset_l, top->top->sub->in_small, top->top->sub->out_small);
